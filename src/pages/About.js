        ...
        <div className='container'>
            ...
            <div className='row align-items-center mt-5'>
                <div className='col-lg-7 paragraph-col'>
                    ...
                    <p className='paragraph about'>Professor Riberio is a Brazilian Jiu-Jitsu instructor and Professional competitor from Manaus, Brazil. Royler Gracie presented him with his Black Belt at the age of 17. He continues to compete around the country and instructs regularly scheduled classes and privately.</p></div>
                <div className='col-lg-5'>
