            ...
            <div className='container'>
                <div className='row mt-4 justify-content-evenly align-items-center'>
                    ...
                    <div className='col-lg-6 paragraph-col ps-5'>
                        ...
                        <h4 className='Schedule-paragraph text-muted mb-3'>7PM - 8PM <span className='ms-4 Schedule-span'>NOGI Jiu Jitsu</span></h4>

                        <h1 className='mt-5 day'>TUESDAY</h1>
                        <h4 className='Schedule-paragraph text-muted'>6PM - 7PM <span className='ms-4 Schedule-span'>GI BJJ Fundamentals</span></h4>
                        <h4 className='Schedule-paragraph text-muted mb-3'>7PM - 8PM <span className='ms-4 Schedule-span'>GI BJJ Advanced</span></h4>
